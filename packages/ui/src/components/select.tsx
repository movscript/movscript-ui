...
>(({ className, children, size = "default", ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDownIcon className="ms-select__icon" />
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    ...
    >
      ...
      <SelectPrimitive.Viewport className="ms-select__viewport">
        {children}
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label ref={ref} className={cn("ms-select__label", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator ref={ref} className={cn("ms-select__separator", className)} {...props} />
));
